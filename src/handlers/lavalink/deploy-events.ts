...
export function deployLavalinkEvents(client: BotClient) {
    ...
    client.lavaManager!.on("trackStart", (player, track) => {
        ...
        const emb = new EmbedBuilder()
            ...
            .setThumbnail(`https://img.youtube.com/vi/${track.info.identifier}/hqdefault.jpg`) // Asegúrate de que track.info.thumbnail es una URL válida
            .setFooter({
                text: `Quedan ${player.queue.tracks.length} canciones mas en cola.`,
            });
