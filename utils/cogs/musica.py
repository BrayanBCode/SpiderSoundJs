...
class musica(commands.Cog):
    ...
    async def forceplay(self, ctx: commands.Context, posición: int):
        await ctx.respond("Sin implementar")
    ...
    async def skip(self, ctx: commands.Context, posición: int = None):
        await ctx.respond("Sin implementar")
    ...
    async def remove(self, ctx: commands.Context, posición: int):
        await ctx.respond("Sin implementar")
